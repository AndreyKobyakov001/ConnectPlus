...
//            MainOld.winner((currentPlayer == 'X') ? username : secondPlayer, (currentPlayer == 'X') ? secondPlayer : username);
//            System.exit(0);
//        }
//
...
//                MainOld.winner((currentPlayer == 'X') ? username : secondPlayer, (currentPlayer == 'X') ? secondPlayer : username);
//                System.exit(0);
//            } else if (board.isFull() || moves.size() == board.getHeight() * board.getWidth()) {
//                board.displayBoard();
...
//                    MainOld.winner("Bot", "Entities.Player");
//                    System.exit(0);
//                }
//            }
//
